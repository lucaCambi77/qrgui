...
/**
 * Classe che implementa Callable e permette di eseguire un task di esecuzione di una query. N.B.
 * Poichè è un task asincrono, nel contesto spring è necessario utilizzare {@link
 * EntityManagerFactory} per poi ricavare l'entityManager. Altrimenti non si può accedere in maniera
 * sistematica alla persistence Unit
 *
 * @author luca
 */
@Component
...
public class ExecuteQueryTask implements Callable<XWrappedResponse<Temi15UteQue, List<Object>>> {
  ...
  public List<Object> getByNativeQuery(
      String nativeQuery, Integer page, EntityManager entityManager) {
  ...
  public WrappedResponse<String> getFinalQueryString(
      Temi15UteQue query, Integer page, Integer pageSize) throws IOException {
