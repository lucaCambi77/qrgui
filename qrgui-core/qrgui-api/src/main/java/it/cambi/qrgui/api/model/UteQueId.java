...
public class UteQueId implements java.io.Serializable {
  ...
  public UteQueId(long que, Date insQue) {
    this.que = que;
    this.insQue = insQue;
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof UteQueId)) return false;
    UteQueId castOther = (UteQueId) other;
