...
public class UteRouId implements java.io.Serializable {
  ...
  public UteRouId(long rou, Date insRou) {
    this.rou = rou;
    this.insRou = insRou;
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof UteRouId)) return false;
    UteRouId castOther = (UteRouId) other;
